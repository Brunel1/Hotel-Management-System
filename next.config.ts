...
const nextConfig: NextConfig = {
  ...
  // Configuration du caching et de la performance
  compress: true,
  // Configuration des en-têtes de sécurité et de cache
  async headers() {
    ...
    return [
      ...
      // Ne définir Cache-Control pour _next/static qu'en production
      ...(isProduction ? [{
  ...
  // Note: Pour une production, vous devrez ajuster les directives CSP selon vos besoins
  /*
  async headers() {
    return [
      {
